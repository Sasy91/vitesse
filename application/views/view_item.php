        ...
        <div class="row">
            ...
            <div class="col-sm-6">
                <div class="col-xs-12" id="slider">
                            ...
                            <div class="carousel slide" id="myCarousel">
                                ...
                                <div class="carousel-inner">
                                    <div class="active item" data-slide-number="0">
                                        <img src="<?php echo base_url(); ?>/resoures/img/shop/item_four.jpg"></div>
                                ...
                                <ul class="hide-bullets">
                                    <li class="col-sm-3">
                                        <a class="thumbnail" id="carousel-selector-0">
                                            <img src="<?php echo base_url(); ?>/resoures/img/shop/item_four.jpg">
                                        </a>
                                    </li>

                                    <li class="col-sm-3">
                                        <a class="thumbnail" id="carousel-selector-1"><img src="<?php echo base_url(); ?>/resoures/img/shop/item_four.jpg"></a>
                                    </li>

                                    <li class="col-sm-3">
                                        <a class="thumbnail" id="carousel-selector-2"><img src="<?php echo base_url(); ?>/resoures/img/shop/item_four.jpg"></a>
                                    </li>

                                    <li class="col-sm-3">
                                        <a class="thumbnail" id="carousel-selector-3"><img src="<?php echo base_url(); ?>/resoures/img/shop/item_four.jpg"></a>
                                    </li>
                                </ul>
                             </div>    
                           </div>
                   ...
                   <div class="col-sm-6">
                         <div class="info-set">
                                <h4>SAINT CECILIA ASHTRAY</h4>
                       <p>$55.00</p>
                       <hr>
                       <h3 > dicta velit facilis eaque itaque nobis tempora.</h3>
                       <hr>
                         <p><p> <button type="button" class="btn btn-labeled btn-primary">
                        <span class="btn-label"><i class="fa fa-shopping-cart"></i></span>view item</button> </p></p>
                        <hr>
                         </div><!--info-set-->
                        </div>
                          </div><!--row-->
                  ...
                  <section id="others">
                          <div class="container">
                              <div class="row">
                                  ...
                                  <div class="item"><div class="mas"><a href=""><img src="<?php echo base_url(); ?>/resoures/img/shop/item_four.jpg" alt="Camp poe shop items"></a></div></div>
                                  <div class="item"><div class="mas"><a href=""><img src="<?php echo base_url(); ?>/resoures/img/shop/item_four.jpg" alt="Camp poe shop items"></a></div></div>
                                  <div class="item"><div class="mas"><a href=""><img src="<?php echo base_url(); ?>/resoures/img/shop/item_four.jpg" alt="Camp poe shop items"></a></div></div>
                                  <div class="item"><div class="mas"><a href=""><img src="<?php echo base_url(); ?>/resoures/img/shop/item_four.jpg" alt="Camp poe shop items"></a></div></div>
                                  <div class="item"><div class="mas"><a href=""><img src="<?php echo base_url(); ?>/resoures/img/shop/item_four.jpg" alt="Camp poe shop items"></a></div></div>
