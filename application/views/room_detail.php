                ...
                <section class="standard-slider room-slider">
                    <div class="col-sm-12 col-md-8">
                        <div id="owl-standard" class="owl-carousel">
                            <div class="item"> <a href="<?php echo base_url(); ?>/resoures/images/rooms/slider/750x481.gif" data-rel="prettyPhoto[gallery1]"><img src="<?php echo base_url(); ?>/resoures/images/rooms/slider/750x481.gif" alt="Image 2" class="img-responsive"></a> </div>
                            <div class="item"> <a href="<?php echo base_url(); ?>/resoures/images/rooms/slider/750x481.gif" data-rel="prettyPhoto[gallery1]"><img src="<?php echo base_url(); ?>/resoures/images/rooms/slider/750x481.gif" alt="Image 2" class="img-responsive"></a> </div>
                        </div>
                    </div>
                </section>
